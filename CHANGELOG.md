# Changelog — Sovereign AutoPackager
...
### Added
- Initial production release of Sovereign AutoPackager (PKG-019)
- Core microservice on port `8797`
- n8n webhook adapter (`n8n/webhook_adapter.py`)
- REST API (`POST /api/v1/execute`, `GET /health`)
- Components: ScaffoldEngine, ReleaseBuilder, TemplateLinter, CICDEmitter, ManifestValidator
- pyproject.toml packaging with `[dev]` extras
- CLI: `sovereign-autopackager --help`
...
[Unreleased]: https://github.com/BlackFoxgamingstudio/autopackager/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/BlackFoxgamingstudio/autopackager/releases/tag/v1.0.0
