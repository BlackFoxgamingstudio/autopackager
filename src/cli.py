#!/usr/bin/env python3
"""
CLI entrypoint for sovereign-autopackager
"""
import sys
import json
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Meta-developer tooling that automatically wraps raw source code into standardized Python libraries with pyproject.toml, pytest suites, Dockerfiles, and n8n webhook adapters, plus blameless post-mortem templates.")
